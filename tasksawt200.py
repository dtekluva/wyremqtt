...
def repackage_for_awt200(data):
    ...
    template = {
            ...
            "meterStatus":"normal",
            "ch":0,
            "ua":float(data.get("Ua")),
            "ub":float(data.get("Ub")),
            "uc":float(data.get("Uc")),
            "ia":float(data.get("Ia")),
            "ib":float(data.get("Ib")),
            "ic":float(data.get("Ic")),
            "pa":float(data.get("Pa")),
            "pb":float(data.get("Pb")),
            "pc":float(data.get("Pc")),
            "p":float(data.get("P")),
            "qa":float(data.get("Qa")),
            "qb":float(data.get("Qb")),
            "qc":float(data.get("Qc")),
            "q":float(data.get("Q")),
            "pfa":float(data.get("PFa")),
            "pfb":float(data.get("PFb")),
            "pfc":float(data.get("PFc")),
            "pf":float(data.get("PF")),
            "pt":1,
            "ct":1,
            "wh":float(data.get("EP")),
            "wl":float(data.get("EQ")),
            "varh":float(data.get("reported",0)),
            "varl":47.28,
            "hz":float(data.get( "Fr"))
            }
    return template
